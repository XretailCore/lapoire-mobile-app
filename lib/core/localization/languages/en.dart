...
Map<String, String> getEnglishTranslation() => {
      ...
      Translate.youMightLoveThis.name: "You Might Love This",
      ...
      Translate.verifyYourAccount.name: "Verify Your Account",
      ...
      Translate.removeItem.name: 'Remove Item',
      ...
      Translate.areYouWantToRemoveThisItem.name:
